...
```
    ...
    attr<K extends keyof JQuery.CommonAttrs>(attributeName: K,
...
```
*/
    attr(attributes: JQuery.CommonAttrs): this;
    /**
...
```
    ...
    attr<K extends keyof JQuery.CommonAttrs>(attributeName: K): string;
    /**
...
```
     */
    css<E extends keyof CSSStyleDeclaration>(propertyName: E, value: string | number | 
      ((this: TElement, index: number, value: string) => string | number | void | undefined)): this;
    /**
     * Set one or more CSS properties for the set of matched elements.
...
```
    ...
    css(properties: JQuery.PartailObject<CSSStyleDeclaration, string | number | ((this: TElement, index: number, value: string) => string | number | void | undefined)>): this;
...
```
     ...
     * @since 1.7
     */
    on<TType extends keyof JQuery.EventMap,
       TData>(
        events: TType,
        selector: JQuery.Selector,
        data: TData,
...
```
    ...
    on<TType extends keyof JQuery.EventMap>(
        events: TType,
        handler: (evnet: JQuery.Event) => void
    ): this;
    /**
     * Attach an event handler function for one or more events to the selected elements.
     * @param events One or more space-separated event types and optional namespaces, such as "click" or "keydown.myPlugin".
...
```
    ...
    trigger<K extends keyof JQuery.EventMap>(eventType_event: K, extraParameters?: any[] | JQuery.PlainObject | string | number | boolean): this;
