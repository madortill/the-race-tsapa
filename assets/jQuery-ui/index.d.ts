...
declare namespace JQueryUI {
    ...
    interface DialogButtonOptions {
        ...
        text?: string;
        click?: (eventObject: JQuery.Event) => any;
    ...
    interface SortableOptions extends SortableEvents {
        appendTo?: JQuery | Element | JQuery.Selector | string; // jQuery, Element, Selector or string
        attribute?: string;
        axis?: string;
        cancel?: JQuery.Selector;
        connectWith?: JQuery.Selector;
        containment?: JQuery | Element | JQuery.Selector | string; // Element, Selector or string
        cursor?: string;
        cursorAt?: {left?: number, top?: number};
        delay?: number;
        disabled?: boolean;
        distance?: number;
        dropOnEmpty?: boolean;
        ...
        handle?: JQuery.Selector | Element; // Selector or Element
        items?: JQuery | JQuery.Selector; // Selector
        opacity?: number;
        placeholder?: string;
        revert?: boolean | number; // boolean or number
        scroll?: boolean;
        scrollSensitivity?: number;
        scrollSpeed?: number;
        tolerance?: string;
    ...
    interface SortableEvent {
        (event: JQuery.Event, ui: SortableUIParams): void;
    }
    ...
    interface SpinnerOptions extends SpinnerEvents {
        ...
        disabled?: boolean;
        icons?: any;
        incremental?: boolean | (() => boolean); // boolean or ()
        max?: number | string; // number or string
        min?: number | string; // number or string
        numberFormat?: string;
        page?: number;
        step?: number | string; // number or string
    }
    ...
    interface TabsOptions extends TabsEvents {
        active?: boolean | number; // boolean or number
        classes?: TabClasses;
        collapsible?: boolean;
        disabled?: boolean | boolean[]; // boolean or []
        event?: string;
        heightStyle?: string;
        hide?: boolean | number | string | JQuery.PlainObject; // boolean, number, string or object
        show?: boolean | number | string | JQuery.PlainObject; // boolean, number, string or object
    }
    ...
    interface TooltipOptions extends TooltipEvents {
        ...
        hide?: boolean | number | string | JQuery.PlainObject; // boolean, number, string or object
        items?: string|JQuery;
        position?: {left?: number, top?: number}; // TODO
        show?: boolean | number | string | JQuery.PlainObject; // boolean, number, string or object
...
interface JQuery {
    ...
    menu: {
        ...
        (methodName: 'collapse', event?: JQuery.Event): void;
        (methodName: 'collapseAll', event?: JQuery.Event, all?: boolean): void;
        (methodName: 'destroy'): void;
        (methodName: 'disable'): void;
        (methodName: 'enable'): void;
        (methodName: string, event: JQuery.Event, item: JQuery): void;
        (methodName: 'focus', event: JQuery.Event, item: JQuery): void;
        (methodName: 'isFirstItem'): boolean;
        (methodName: 'isLastItem'): boolean;
        (methodName: 'next', event?: JQuery.Event): void;
        (methodName: 'nextPage', event?: JQuery.Event): void;
        (methodName: 'previous', event?: JQuery.Event): void;
        (methodName: 'previousPage', event?: JQuery.Event): void;
        (methodName: 'refresh'): void;
        (methodName: 'select', event?: JQuery.Event): void;
    ...
    sortable<K extends keyof JQueryUI.SortableOptions>(optionLiteral: 'option', optionName: K): JQueryUI.SortableOptions[K];
    ...
    position(options: JQueryUI.PositionOptions): JQuery;
